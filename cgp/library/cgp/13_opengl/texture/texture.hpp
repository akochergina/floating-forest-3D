...
namespace cgp
{
	struct opengl_texture_image_structure
	{
		...
		// Shortcut to initialize_snake a GL_TEXTURE_2D from an image described by its filename
	...
	// Read an image from file and initialize_snake an opengl texture image from it
