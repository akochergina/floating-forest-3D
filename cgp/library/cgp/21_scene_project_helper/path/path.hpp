...
namespace cgp {
	...
	// This function should be called at the beginning of the program to initialize_snake the relative path
	// ex. std::string path_project = helper_path_project::initialize_snake(argv[0]);
